...
@section('page-header')
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Nouveau Contact</h1>
            <p class="text-slate-600 mt-1">Ajouter un nouveau contact au référentiel</p>
        </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('contacts.store') }}"
            ...
            <div class="p-6 border-b border-slate-200">
                ...
                <p class="text-sm text-slate-600 mt-1">Les informations de base du contact</p>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="form-control">
                    ...
                    <textarea name="notes"
                              ...
                              placeholder="Notes personnelles sur ce contact...">{{ old('notes') }}</textarea>
                    @error('notes')
                    <label class="label">
                        <span class="label-text-alt text-red-500">{{ $message }}</span>
                    </label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                                ...
                                <div class="form-control md:col-span-4">
                                    ...
                                    <input type="date" name="organisations[0][date_fin]"
                                           class="input input-bordered w-full"
                                           value="{{ old('organisations.0.date_fin') }}">
                                </div>
...
@push('breadcrumbs')
    ...
    <li>
        <span class="text-slate-500">Nouveau contact</span>
    </li>
@endpush
